...
public class App {
    ...
    public void printInstructions() {
        ...
        System.out.println("Very innapropriate content below.");
    }
    ...
    public void doMadlib() {
        ...
        System.out.println("Last night, I went to the most" + adj1 + "party thrown by none other than" + noun1
                ...
                + "so loud, even the" + pnoun4 + "outside could hear them! There were tables full of" + pnoun5 + "and"
                + noun4 + ",and drinks that tasted like" + adj4 + ".Diddy gave a speech about this" + adj5
                + "career and thanked his" + adj6 + "fans. Then, the crowd went wild then a surprise guest," + noun5
                + ", arrived riding a" + noun6 + ". The night ended with" + pnoun6
                + "falling from the ceiling, and everyone left feeling" + adj7
                + ". It was definently a party to remember.");
    }
